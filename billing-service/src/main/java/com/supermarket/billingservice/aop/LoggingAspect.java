package com.supermarket.billingservice.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.supermarket.billingservice.controller..*)")
    public void controllerLayer() {
    }

    @Pointcut("within(com.supermarket.billingservice.service..*)")
